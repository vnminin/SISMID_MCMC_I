...
N3  = 275  # frequency of chains of size 3 (i.e., 1->1->1 or 1->2)
...
for (i in 2:mcmc.size){
 ...
 # households with chain 1->1->1 or 1->2 (i.e. with final size 3)
 for (j in 1:275){
...
mcmc.sample = chain_hierarchical_reduced(mcmc.size=2000)
